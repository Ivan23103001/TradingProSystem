...
- `bot_worker.py`: El "proceso obrero" que corre en segundo plano para el Auto-Trading.
...
5. **Sincronización Obligatoria (SYNC):** Antes de finalizar cualquier cambio, se DEBE verificar el cumplimiento del `SYNC_PROTOCOL.md` para asegurar que el Frontend, el Backend y el Cerebro estén actualizados y en armonía.
